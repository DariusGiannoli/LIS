...
class LocationStudyInterface:
    ...
    This interface follows the exact same randomization logic as location_study.py
    ...
    def create_study_sequence(self):
        """Create randomized study sequence following location_study.py logic"""
        
        # Create random indices exactly like location_study.py
        ...
        # Create the same random orders as location_study.py
        ...
        # Create study sequence with combined patterns
...
New Combined Randomization (same as location_study.py):
- All horizontal patterns (static/pulse/motion) mixed together
- All vertical patterns (static/pulse/motion) mixed together

Base Random Orders:
Horizontal: {self.horizontal_random_order}
Vertical: {self.vertical_random_order}
...
Click 'Play Pattern' to begin."""
    ...
    def study_complete(self):
        ...
        avg_reaction_time = sum(r['reaction_time_ms'] for r in self.results) / total_patterns if total_patterns > 0 else 0
