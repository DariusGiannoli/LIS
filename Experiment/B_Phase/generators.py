...
from study_params import MOTION_PARAMS, FREQ, DURATION, DUTY, PULSE_DURATION, PAUSE_DURATION, NUM_PULSES, MOTION_DURATION
from widgets.actuator_grid import GRID_POSITION
@dataclass
class MotionCommand:
    actuator_id: int
    intensity: float
