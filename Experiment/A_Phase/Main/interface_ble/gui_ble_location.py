...
class LocationStudyInterface:
    """
    GUI Interface for Location Study - Tactile Pattern Recognition (Bluetooth Version)
    
    Based on the existing interface but adapted for full_loc_study.py logic.
    Enhanced with Previous/New Study functionality and Bluetooth Low Energy communication.
    ...
    def __init__(self, root):
        self.root = root
        self.root.title("Location Study Interface - Bluetooth Version")
    ...
    def setup_gui(self):
        ...
        self.title_label = ttk.Label(
            title_timer_frame, 
            text="Location Study - Tactile Pattern Recognition (Bluetooth)",
            font=('Arial', 16, 'bold')
        )
...
- 'New Study' to start a fresh study with new randomization"""
    ...
    def save_results(self):
        ...
        filename = f"location_study_ble_results_{self.participant_id}_{timestamp}"
