...
class SizeStudyInterface:
    """
    GUI Interface for Size Study - Tactile Size Discrimination
    ...
    def __init__(self, root):
        self.root = root
        self.root.title("Size Study Interface - Enhanced")
    ...
    def setup_gui(self):
        ...
        self.title_label = ttk.Label(
            header_frame, 
            text="Size Study - Tactile Size Discrimination (Enhanced)",
            font=('Arial', 16, 'bold')
        )
    ...
    def create_study_sequence(self):
        ...
        print(f"Motion-only random order: {[p['name'] for p in pattern_list]}")
...
- 'New Study' to start a fresh study with new randomization"""
    ...
    def save_results(self):
        ...
        filename = f"size_study_results_{self.participant_id}_{timestamp}"
